...
public class S1AgentRaycastsFind : Agent
{
    ...
    private RaycastObservation[] GetRaycastObservations()
    {
        ...
        for (int i = 0; i < numberOfRays; i++)
        {
            ...
            raycastObservation.warehousHit = false;
            ...
            if (blocked)
            {
                ...
                if ( hit.collider.transform == warehouseTransform)
                {
                    raycastObservation.warehousHit = true;
